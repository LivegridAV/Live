...
export const WORLDS = [
  { id: "anamorphic", index: "01", title: "Anamorphic Stage", kind: "HERO CONCEPT",
    heroLines: ["WE TURN IDEAS", "INTO UNFORGETTABLE", "EXPERIENCES"],
    cta: "EXPLORE OUR WORLD",
    tags: ["Corporate", "Social Events", "Music Festivals", "Clubs & Installations"] },
  { id: "corporate", index: "02", title: "Corporate Experience", kind: "HERO CONCEPT",
    heroLines: ["EVENTS", "THAT INSPIRE", "PROGRESS"],
    cta: "STEP INSIDE",
    tags: ["Immersive Stage", "3D Content", "Live Production", "Hybrid Events"] },
  { id: "festival", index: "03", title: "Music Festival Vibes", kind: "HERO CONCEPT",
    heroLines: ["MUSIC", "PEOPLE", "VISUALS TOGETHER"],
    cta: "FEEL THE ENERGY",
    tags: ["Festivals", "Clubs & Pubs", "Live Visuals", "Interactive Stage"] },
  { id: "social", index: "04", title: "Social Event Magic", kind: "HERO CONCEPT",
    heroLines: ["MOMENTS", "THAT LIVE", "FOREVER"],
    cta: "EXPLORE SCENE",
    tags: ["LED Stages", "3D Environments", "Anamorphic Content", "Floor LED"] },
  { id: "installation", index: "05", title: "360° Interactive Stage", kind: "HERO CONCEPT",
