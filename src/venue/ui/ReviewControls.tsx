...
/** Development-only shot selector for repeatable visual regression review. */
export function ReviewControls() {
  const panelOpen = useVenue(s => Boolean(s.activePavilion));
  if (process.env.NODE_ENV !== "development" || panelOpen) return null;
  return <><output data-render-metrics aria-label="Render metrics" style={{position:"fixed",right:28,top:126,zIndex:100,fontSize:10,color:"#ccc",background:"#15191ecc",padding:"4px 7px",borderRadius:4,pointerEvents:"none"}} />
